...
```AudioPlayerComponent variableName = AudioPlayerComponent.spawnNewAudioComponentEntity(vector3dSpawnPosition, componentAccessor)``` <sup>componentAccessor can anything implementing ComponentAccessor e.g. Store or CommandBuffer</sup>"
